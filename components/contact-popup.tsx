...
export function ContactPopup() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // 1. Data voorbereiden voor GHL (via URL parameters zoals de browser-test)
      ...
      // 2. Data voorbereiden voor Web3Forms (JSON)
      const web3Payload = {
      ...
      // 3. Beide versturen
      await Promise.all([
        // GHL via de URL methode die werkte
        fetch(`${GHL_WEBHOOK_URL}?${queryParams}`, {
          method: "GET",
          mode: "no-cors",
        }),
        // Web3Forms via de standaard methode
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border ${errors.name ? "border-red-400" : "border-[#072AC8]/12"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className={`w-full px-4 py-3 rounded-xl border ${errors.message ? "border-red-400" : "border-[#072AC8]/12"
