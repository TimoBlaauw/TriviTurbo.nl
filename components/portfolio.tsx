  ...
  return (
    <section id="voorbeeld" className="py-20 md:py-28 bg-white scroll-mt-20 overflow-x-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-[#0095FF] font-bold text-sm tracking-wider uppercase mb-4">LIVE VOORBEELD</p>
          ...
          <p className="text-lg text-[#4b5b8a] leading-relaxed">
            Wil je eerst zien wat je krijgt? Dit is één van de websites die we al hebben opgeleverd:
          </p>
        </div>
        ...
        <div
          ...
          className="w-full max-w-5xl mx-auto mb-20 transition-all duration-700 ease-out"
          style={{
        ...
        >
          <div className="bg-gradient-to-br from-[#f0f6ff] to-white rounded-3xl p-6 sm:p-8 md:p-12 border border-[#072AC8]/10 shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center justify-items-center lg:justify-items-stretch">
              {/* Device Mockup */}
                ...
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-[#072AC8]/10">
                  ...
                  <div className="bg-gradient-to-r from-gray-100 to-gray-50 px-4 py-3 flex items-center gap-2 border-b">
                    ...
                    <div className="flex-1 mx-4 min-w-0">
                      <div className="bg-white rounded-md px-3 py-1.5 text-xs text-gray-400 flex items-center gap-2 min-w-0 overflow-hidden">
                        <svg
              ...
              <div className="w-full max-w-[560px] mx-auto lg:max-w-none">
                <h3 className="text-2xl md:text-3xl font-black text-[#072AC8] mb-4">
                  Landal Bad Bentheim 309
                </h3>

                <p className="text-[#4b5b8a] leading-relaxed mb-6">
                  Zo ziet een snelle, professionele vakantiehuiswebsite eruit: rustig design, duidelijke informatie en
                  een sterke route naar een reserveringsaanvraag.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#072AC8] to-[#0095FF] text-white font-bold px-6 py-3 rounded-2xl shadow-lg hover:shadow-xl transition-all hover:scale-105 w-full sm:w-auto"
                  >
                  ...
                  <Button
                    onClick={openPopup}
                    variant="outline"
                    className="border-2 border-[#072AC8]/20 text-[#072AC8] font-bold px-6 py-3 rounded-2xl hover:bg-[#072AC8] hover:text-white transition-all w-full sm:w-auto"
                  >
                    Dit wil ik ook
                  </Button>
                </div>
